<%@ page import="com.dmc.domain.Login" %>
        ...
        <div class="head">
            <div class="navbar">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="/platform">首页</a></li>
            ...
            <%
              if(user !=null){
                  ...
                  <div class="account-dropbox">
                      欢迎您,
                  <a class="login-a ml10" href="/platform/login"><%= user.getUsername()%></a>
                          &nbsp;<span class="divider">|</span>&nbsp;
                  <a href="/platform/login">退出</a>
                  </div>
            <% }
             else{
                  %>
                  <div class="account-dropbox">
                  <a class="login-a ml10" href="/platform/login">登录</a>
                          &nbsp;<span class="divider">|</span>&nbsp;
                  <a href="/platform/register">注册</a>
                  </div>
            <% }
           %>
        ...
        <ul class="contact-ul">
            <li class="contact-li ent">
                ...
                <div class="consult-box">
                    ...
                    <p class="consult-way">社区：<a target="_blank" href="/platform/feedback">去反馈</a>&nbsp;&nbsp;
                        查看反馈信息：<a target="_blank" href="/platform/list">查询反馈信息</a></p>
                </div>
            </li>
