		...
		<div class="module module-content"> 
			...
			<div class="content"> 
				<div class="logo"> 
					...
					<span onclick="location.href='/platform/index'"><strong>返回</strong></span>
				</div>
				<div class="operate">
				    <i class="icon icon-skin" style="background-image: url(img/icon-skin.png);"></i> 
					<i onclick="location.href='/platform/feedback'" class="icon icon-message" style="background-image: url(img/icon-message.png);"></i>
				 ...
				 <ul>
					   <c:forEach items= "${dataList }" var = "processData" varStatus="loop">
						...
						<c:choose>
							...
							<button type="button" class="btn btn-primary" onclick="location.href='/platform/report'">查询</button>
							<!-- popup -->
